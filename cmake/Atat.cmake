...
set(RMC_ATAT_PROVIDER "SYSTEM" CACHE STRING "How corrdump is provided: SYSTEM | FETCH | SOURCE")
set_property(CACHE RMC_ATAT_PROVIDER PROPERTY STRINGS SYSTEM FETCH SOURCE)

set(RMC_ATAT_GIT_REPOSITORY "https://github.com/reach2sayan/atat.git" CACHE STRING "ATAT git repository for FETCH mode")
set(RMC_ATAT_GIT_TAG "main" CACHE STRING "ATAT git tag/branch for FETCH mode")
set(RMC_ATAT_SOURCE_DIR "" CACHE PATH "Path to an existing ATAT checkout (SOURCE mode)")

# CMAKE_ARGS shared by FETCH/SOURCE to build only corrdump from an ATAT tree.
set(_atat_cmake_args -DCMAKE_BUILD_TYPE=Release "-DCMAKE_CXX_FLAGS=-w" -DMAKENDVIEWER=OFF -DUSEGSL=OFF -DATAT_BUILD_CVM=OFF
        -DATAT_BUILD_TESTS=OFF -DUSEPYTHON=OFF  -DATAT_ALLOW_FETCHCONTENT=ON)
...
elseif (RMC_ATAT_PROVIDER STREQUAL "FETCH")
    ...
    ExternalProject_Add(atat_ext GIT_REPOSITORY "${RMC_ATAT_GIT_REPOSITORY}"
            GIT_TAG "${RMC_ATAT_GIT_TAG}" GIT_SHALLOW TRUE
    ...
    set(ATAT_CORRDUMP_PATH "${BINARY_DIR}/bin/corrdump" CACHE FILEPATH "Path to the built corrdump binary" FORCE)
